                ...
                function(res) {
                    ...
                    if (summary == null) {
                        document.querySelectorAll('.icon_acrevus'+String(id))[0].innerHTML += popup_html + 
                            ...
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>" + ratingDescription + "</p>" + 
                            "<p align=\"justify\" style='color:white;font-size:10px;position:absolute;left:13px;top:250px;\
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>(Summary Unavailable)</p>" 
                            + "<p style='color:white;font-size:10px;position:absolute;left:13px;top:90px;\
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>" + String(site_name) + String(trustworthy_rating) +"</p>"
                    } else {
                        var summaryFormatted = summary.replace(new RegExp('{|}|[|]', 'g'), '');
                        document.querySelectorAll('.icon_acrevus'+String(id))[0].innerHTML += popup_html + 
                            "<p align=\"justify\" style='color:white;font-size:10px;position:absolute;left:13px;top:250px;\
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>" + summaryFormatted + "</p>" + 
                            "<p style='color:white;font-size:10px;position:absolute;left:13px;top:196px;\
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>" + ratingDescription + "</p>" 
                            + "<p style='color:white;font-size:10px;position:absolute;left:13px;top:90px;\
                            width:90%;word-wrap:break-word;" + (twitter ? "white-space: normal;margin: 5px 0;line-height:14px;" : "") + "z-index:9999;'>" + String(site_name) + String(trustworthy_rating) + "</p></div>";
                    }
